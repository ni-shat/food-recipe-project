import banner from '../../../assets/signup/signupBanner.jpg';
import './Register.css'
    ...
    return (
        <div className='md:p-4 w-[95%] md:w-[84%] mx-auto'>
            <main className="w-full flex items-center ">
                ...
                <div id="gradient" className="relative w- flex-1 hidden items-center justify-center h-screen bg-gray-100 lg:flex">
                    <div className="relative z-10 w-full max-w-md">
                        <div className=" mt-16 space-y-3">
                            <h3 className="text-gray-800 text-4xl font-bold">Join Our Delicious Journey!</h3>
                            ...
                            <div className="flex items-center -space-x-2 overflow-hidden">
                                ...
                                <p className="text-sm text-slate-700 font-medium translate-x-5">
                                    Join 5.000+ users
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                        <div className="">
                            ...
                            <div className="mt-5 space-y-2">
                                ...
                                <p className="">Already have an account? <a href="javascript:void(0)" className="font-medium text-[#ED8B1F] hover:text-slate-300 active:text-slate-300">Log in</a></p>
                            </div>
                        </div>
