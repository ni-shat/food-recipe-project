    ...
    return (
        <div className='flex md:flex-row flex-col gap-10 md:gap-2 md:w-[80%] w-[100%] mx-auto justify-between'>
            ...
            <div className='md:w-[15%] w-[60%] mx-auto md:mx-0 rounded-full'>
                <img className='rounded-full' src={chicken} alt="" />
