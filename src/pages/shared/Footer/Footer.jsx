...
const Footer = () => {
    ...
    return (
        <footer className="text-gray-500 mt-20 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="gap-6 justify-between md:flex">
                <div className="flex-1 -mt-3">
                    ...
                    >
                        <label className="block pt-4 pb-2 font-sm">
                            Stay up to date
                        </label>
                        <div className="max-w-sm flex items-center border rounded-md p-1 font-sm">
                            <input
                                type="email"
                                placeholder="Enter your email"
                                className="w-full py-1 md:p-2.5 outline-none"
                            />
                            <button
                                className="md:p-2.5 py-1 px-1 rounded text-white bg-[#ED8B1F] outline-none shadow-md focus:shadow-none sm:px-5"
                            >
                                Subscribe
                            </button>
                        </div>
                                ...
                                </h4>
                                {
                                    item.items.map(((el, idx) => (
                                        <li key={idx}>
                                            <a
                                                href={el.href}
                                                className="hover:underline hover:text-indigo-600 text-sm"
            ...
            <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2023 Testeva all rights reserved.
                </div>
