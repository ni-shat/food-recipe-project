...
const Chefs = () => {
    ...
    useEffect(() => {
        fetch('https://chef-project-server-ni-shat.vercel.app/chefs')
            .then(res => res.json())
    ...
    return (
        <div className="md:w-[80%] w-[85%] mx-auto md:mt-32 mt-14">
             ...
             <p className="text-[#ED8B1F] text-center md:mb-14 mb-8 md:mt-4 mt-2 font-medium md:text-base text-xs">Meet the talented chefs behind the recipes you love in Our website.</p>
